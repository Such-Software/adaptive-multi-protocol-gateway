...
CONFIG_FIELDS = (
    ConfigField(
        ...
        False,
        "./.ampg/state",
        "AMPG-owned daemon state and captured address registry root.",
    ),
    ConfigField(
        "gateway",
        "cache_dir",
        ...
        False,
        "./.ampg/cache",
        "AMPG cache root for generated intermediate data.",
    ),
    ConfigField(
        "gateway",
        "run_dir",
        ...
        False,
        "./.ampg/run",
        "Runtime socket and process metadata root for managed daemons.",
    ),
    ConfigField(
        "gateway",
        "user",
        ...
        False,
        "",
        "Preferred service user for generated managed-daemon artifacts.",
    ),
    ...
    ConfigField(
        ...
        False,
        "",
        "Published URL used in fixture manifests and health plans.",
    ),
    ConfigField(
        "site.protocols.<name>",
        "browser_url",
        ...
        False,
        "",
        "Browser-facing URL alias used when fixture_url is not set.",
    ),
    ConfigField(
        "site.protocols.<name>",
        "address_file",
        ...
        False,
        "",
        "Daemon-written public address file consumed by addresses capture.",
    ),
    ConfigField(
        "site.protocols.<name>",
        "max_asset_bytes",
